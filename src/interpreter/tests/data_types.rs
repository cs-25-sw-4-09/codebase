...
fn test_value_partial_cmp() {
    assert_eq!(Value::Integer(5).partial_cmp(&Value::Integer(5)), Some(std::cmp::Ordering::Equal));
    ...
    assert_eq!(Value::Integer(3).partial_cmp(&Value::Integer(5)), Some(std::cmp::Ordering::Less));
    ...
    assert_eq!(Value::Integer(8).partial_cmp(&Value::Integer(5)), Some(std::cmp::Ordering::Greater));

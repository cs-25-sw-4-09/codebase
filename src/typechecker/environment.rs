...
impl TEnvironment {
    ...
    pub fn stable_init(&mut self){
        ...
        path_param.insert("stroke".to_string(), EType::DeclNonDefault(Type::Color));
        path_param.insert("thickness".to_string(), EType::DeclNonDefault(Type::Int));
        ...
        poly_param.insert("stroke".to_string(), EType::DeclNonDefault(Type::Color));
        poly_param.insert("thickness".to_string(), EType::DeclNonDefault(Type::Int));
